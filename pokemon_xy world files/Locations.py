...
location_table: Dict[str, LocationData] = {
    ...
    "Shalour City - Received Eviolite from scientist for seeing at least 40 species in Coastal Pokédex": LocationData(200020, "Shalour Area", category=['ITEM GIFT'], flag_id=0x0097, requires=""),
    ...
    "Lumiose City (South Boulevard) - Received TM54 (False Swipe) from female scientist for seeing at least 20 species in Central Kalos Pokédex": LocationData(200026, "Lumiose Area", category=['ITEM GIFT'], flag_id=0x00B1, requires=""),
    ...
    "Coumarine City - Received Lucky Egg from woman for showing her a Pokémon with maximum friendship": LocationData(200032, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x00B7, requires=""),
    ...
    "Ambrette Town - Received the Douse Drive": LocationData(200039, "Cyllage Area", category=['ITEM GIFT'], flag_id=0x00D5, requires=""),
    ...
    "Lumiose City (Vernal Avenue) - Received Pearl String (x2) from madame for showing her a Furfrou that has kept the same trim for 15 days": LocationData(200055, "Lumiose Area", category=['ITEM GIFT'], flag_id=0x010D, requires=""),
    ...
    "Reflection Cave - Received Reveal Glass from female scientist for showing her a Tornadus / Thundurus / Landorus": LocationData(200060, "Shalour Area", category=['ITEM GIFT'], flag_id=0x011C, requires=""),
    "Azure Bay - Received Ampharosite from old man": LocationData(200061, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x011D, requires=""),
    ...
    "Route 8 - Found Heart Scale": LocationData(200132, "Cyllage Area", category=['HIDDEN ITEM'], flag_id=0x0462, requires="Dowsing Machine"),
    ...
    "Route 8 - Found Heart Scale (recurring)": LocationData(200134, "Cyllage Area", category=['HIDDEN ITEM'], flag_id=0x0464, requires="Dowsing Machine"),
    ...
    "Route 10 - Found Revive": LocationData(200142, "Shalour Area", category=['HIDDEN ITEM'], flag_id=0x046C, requires="Dowsing Machine"),
    ...
    "Azure Bay - Found Star Piece": LocationData(200154, "Coumarine Area", category=['HIDDEN ITEM'], flag_id=0x0478, requires="Dowsing Machine"),
    "Azure Bay - Found Hyper Potion": LocationData(200155, "Coumarine Area", category=['HIDDEN ITEM'], flag_id=0x0479, requires="Dowsing Machine"),
    "Azure Bay - Found Heart Scale": LocationData(200156, "Coumarine Area", category=['HIDDEN ITEM'], flag_id=0x047A, requires="Dowsing Machine"),
    ...
    "Route 13 - Found Hyper Potion": LocationData(200163, "Lumiose Area", category=['HIDDEN ITEM'], flag_id=0x0481, requires="Dowsing Machine"),
    "Route 13 - Found PP Up": LocationData(200164, "Lumiose Area", category=['HIDDEN ITEM'], flag_id=0x0482, requires="Dowsing Machine"),
    "Route 13 - Found X Accuracy": LocationData(200165, "Lumiose Area", category=['HIDDEN ITEM'], flag_id=0x0483, requires="Dowsing Machine"),
    "Route 13 - Found Stardust": LocationData(200166, "Lumiose Area", category=['HIDDEN ITEM'], flag_id=0x0484, requires="Dowsing Machine"),
    ...
    "Route 15 - Found HP Up": LocationData(200179, "Laverre Area", category=['HIDDEN ITEM'], flag_id=0x0491, requires="Dowsing Machine"),
    "Route 15 - Found Antidote": LocationData(200180, "Laverre Area", category=['HIDDEN ITEM'], flag_id=0x0492, requires="Dowsing Machine"),
    "Route 15 - Found Tiny Mushroom": LocationData(200181, "Laverre Area", category=['HIDDEN ITEM'], flag_id=0x0493, requires="Dowsing Machine"),
    "Route 15 - Found X Defense": LocationData(200182, "Laverre Area", category=['HIDDEN ITEM'], flag_id=0x0494, requires="Dowsing Machine"),
    "Route 15 - Found Pretty Wing": LocationData(200183, "Laverre Area", category=['HIDDEN ITEM'], flag_id=0x0495, requires="Dowsing Machine"),
    "Route 16 - Found Repel": LocationData(200184, "Laverre Area", category=['HIDDEN ITEM'], flag_id=0x0496, requires="Dowsing Machine"),
    "Route 16 - Found Rare Candy": LocationData(200185, "Laverre Area", category=['HIDDEN ITEM'], flag_id=0x0497, requires="Dowsing Machine"),
    ...
    "Route 18 - Found Timer Ball": LocationData(200201, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04A7, requires="Dowsing Machine"),
    "Route 18 - Found Paralyze Heal": LocationData(200202, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04A8, requires="Dowsing Machine"),
    ...
    "Route 19 - Found Poké Ball": LocationData(200207, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04AD, requires="Dowsing Machine"),
    "Route 19 - Found Ether": LocationData(200208, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04AE, requires="Dowsing Machine"),
    "Route 19 - Found Honey": LocationData(200209, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04AF, requires="Dowsing Machine"),
    "Route 19 - Found Super Potion": LocationData(200210, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04B0, requires="Dowsing Machine"),
    ...
    "Terminus Cave - Found Moon Stone": LocationData(200213, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04B3, requires="Dowsing Machine"),
    ...
    "Terminus Cave - Found Max Potion": LocationData(200217, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04B7, requires="Dowsing Machine"),
    ...
    "Terminus Cave - Found Normal Gem": LocationData(200219, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04B9, requires="Dowsing Machine"),
    ...
    "Couriway Town - Found Prism Scale (recurring)": LocationData(200223, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04BD, requires="Dowsing Machine"),
    "Route 20 - Found Net Ball": LocationData(200224, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04BE, requires="Dowsing Machine"),
    "Route 20 - Found Antidote": LocationData(200225, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04BF, requires="Dowsing Machine"),
    "Route 20 - Found Damp Rock": LocationData(200226, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04C0, requires="Dowsing Machine"),
    "Route 20 - Found Escape Rope": LocationData(200227, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04C1, requires="Dowsing Machine"),
    "Route 20 - Found Timer Ball": LocationData(200228, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04C2, requires="Dowsing Machine"),
    ...
    "Route 21 - Found Repeat Ball": LocationData(200232, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04C6, requires="Dowsing Machine"),
    "Route 21 - Found Antidote": LocationData(200233, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04C7, requires="Dowsing Machine"),
    "Route 21 - Found Mental Herb": LocationData(200234, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04C8, requires="Dowsing Machine"),
    "Route 21 - Found Tiny Mushroom": LocationData(200235, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04C9, requires="Dowsing Machine"),
    "Route 21 - Found Balm Mushroom": LocationData(200236, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04CA, requires="Dowsing Machine"),
    "Pokémon Village - Found Honey": LocationData(200237, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04CB, requires="Dowsing Machine"),
    ...
    "Pokémon Village - Found Honey (2)": LocationData(200239, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04CD, requires="Dowsing Machine"),
    "Route 22 - Found Guard Spec.": LocationData(200240, "Victory Road", category=['HIDDEN ITEM'], flag_id=0x04CE, requires="Dowsing Machine"),
    "Route 22 - Found PP Up": LocationData(200241, "Victory Road", category=['HIDDEN ITEM'], flag_id=0x04CF, requires="Dowsing Machine"),
    "Route 22 - Found Pearl String": LocationData(200242, "Victory Road", category=['HIDDEN ITEM'], flag_id=0x04D0, requires="Dowsing Machine"),
    "Route 22 - Found Elixir": LocationData(200243, "Victory Road", category=['HIDDEN ITEM'], flag_id=0x04D1, requires="Dowsing Machine"),
    "Route 22 - Found Max Elixir": LocationData(200244, "Victory Road", category=['HIDDEN ITEM'], flag_id=0x04D2, requires="Dowsing Machine"),
    "Route 22 - Found Full Restore": LocationData(200245, "Victory Road", category=['HIDDEN ITEM'], flag_id=0x04D3, requires="Dowsing Machine"),
    ...
    "Victory Road - Found Ultra Ball": LocationData(200249, "Victory Road", category=['HIDDEN ITEM'], flag_id=0x04D7, requires="Dowsing Machine"),
    ...
    "Victory Road - Found Revive": LocationData(200251, "Victory Road", category=['HIDDEN ITEM'], flag_id=0x04D9, requires="Dowsing Machine"),
    ...
    "Victory Road - Found Max Ether": LocationData(200256, "Victory Road", category=['HIDDEN ITEM'], flag_id=0x04DE, requires="Dowsing Machine"),
    ...
    "Unknown Dungeon - Found Oval Stone (recurring)": LocationData(200261, "Snowbelle Area", category=['HIDDEN ITEM'], flag_id=0x04E3, requires="Dowsing Machine"),
    ...
    "Route 3 - Revive item ball disappeared": LocationData(200265, "Santalune Area", category=['FIELD ITEM'], flag_id=0x051D, requires=""),
    "Route 3 - Dawn Stone item ball disappeared": LocationData(200266, "Santalune Area", category=['FIELD ITEM'], flag_id=0x051E, requires=""),
    "Route 22 - Super Potion item ball disappeared": LocationData(200267, "Victory Road", category=['FIELD ITEM'], flag_id=0x051F, requires=""),
    "Route 22 - Elixir item ball disappeared": LocationData(200268, "Victory Road", category=['FIELD ITEM'], flag_id=0x0520, requires=""),
    "Route 22 - Draco Plate item ball disappeared": LocationData(200269, "Victory Road", category=['FIELD ITEM'], flag_id=0x0521, requires=""),
    ...
    "Route 5 - Sharp Beak item ball disappeared": LocationData(200282, "Camphrier Area", category=['FIELD ITEM'], flag_id=0x052E, requires=""),
    ...
    "Route 7 - Silver Powder item ball disappeared": LocationData(200294, "Cyllage Area", category=['FIELD ITEM'], flag_id=0x053A, requires=""),
    "Connecting Cave - TM40 (Aerial Ace) item ball disappeared": LocationData(200295, "Cyllage Area", category=['FIELD ITEM'], flag_id=0x053B, requires=""),
    ...
    "Route 8 - Water Stone item ball disappeared": LocationData(200298, "Cyllage Area", category=['FIELD ITEM'], flag_id=0x053E, requires="HM03 Surf"),
    "Route 8 - Heart Scale item ball disappeared": LocationData(200299, "Cyllage Area", category=['FIELD ITEM'], flag_id=0x053F, requires=""),
    "Route 8 - TM19 (Roost) item ball disappeared": LocationData(200300, "Cyllage Area", category=['FIELD ITEM'], flag_id=0x0540, requires=""),
    ...
    "Route 10 - TM73 (Thunder Wave) item ball disappeared": LocationData(200307, "Shalour Area", category=['FIELD ITEM'], flag_id=0x0547, requires=""),
    ...
    "Route 11 - TM69 (Rock Polish) item ball disappeared": LocationData(200311, "Shalour Area", category=['FIELD ITEM'], flag_id=0x054B, requires=""),
    ...
    "Route 12 - Sachet item ball disappeared": LocationData(200322, "Coumarine Area", category=['FIELD ITEM'], flag_id=0x0556, requires=""),
    ...
    "Route 12 - Leftovers item ball disappeared": LocationData(200326, "Coumarine Area", category=['FIELD ITEM'], flag_id=0x055A, requires=""),
    "Azure Bay - Deep Sea Tooth item ball disappeared": LocationData(200327, "Coumarine Area", category=['FIELD ITEM'], flag_id=0x055B, requires=""),
    "Azure Bay - TM81 (X-Scissor) item ball disappeared": LocationData(200328, "Coumarine Area", category=['FIELD ITEM'], flag_id=0x055C, requires=""),
    "Azure Bay - Dive Ball item ball disappeared": LocationData(200329, "Coumarine Area", category=['FIELD ITEM'], flag_id=0x055D, requires=""),
    "Azure Bay - Big Pearl item ball disappeared": LocationData(200330, "Coumarine Area", category=['FIELD ITEM'], flag_id=0x055E, requires=""),
    "Azure Bay - Splash Plate item ball disappeared": LocationData(200331, "Coumarine Area", category=['FIELD ITEM'], flag_id=0x055F, requires=""),
    "Route 13 - Smooth Rock item ball disappeared": LocationData(200332, "Lumiose Area", category=['FIELD ITEM'], flag_id=0x0560, requires=""),
    "Route 13 - Burn Heal item ball disappeared": LocationData(200333, "Lumiose Area", category=['FIELD ITEM'], flag_id=0x0561, requires=""),
    "Route 13 - TM57 (Charge Beam) item ball disappeared": LocationData(200334, "Lumiose Area", category=['FIELD ITEM'], flag_id=0x0562, requires=""),
    "Route 13 - Flame Plate item ball disappeared": LocationData(200335, "Lumiose Area", category=['FIELD ITEM'], flag_id=0x0563, requires=""),
    "Route 13 - Sun Stone item ball disappeared": LocationData(200336, "Lumiose Area", category=['FIELD ITEM'], flag_id=0x0564, requires=""),
    "Route 13 - Rare Candy item ball disappeared": LocationData(200337, "Lumiose Area", category=['FIELD ITEM'], flag_id=0x0565, requires=""),
    ...
    "Route 14 - Damp Rock item ball disappeared": LocationData(200341, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0569, requires=""),
    "Route 14 - Spell Tag item ball disappeared": LocationData(200342, "Laverre Area", category=['FIELD ITEM'], flag_id=0x056A, requires=""),
    "Route 14 - TM61 (Will-O-Wisp) item ball disappeared": LocationData(200343, "Laverre Area", category=['FIELD ITEM'], flag_id=0x056B, requires=""),
    ...
    "Route 15 - PP Up item ball disappeared": LocationData(200352, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0574, requires=""),
    "Route 15 - Full Heal item ball disappeared": LocationData(200353, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0575, requires=""),
    "Route 15 - Protein item ball disappeared": LocationData(200354, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0576, requires=""),
    "Route 15 - Macho Brace item ball disappeared": LocationData(200355, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0577, requires=""),
    "Route 15 - Stone Plate item ball disappeared": LocationData(200356, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0578, requires=""),
    "Route 15 - TM97 (Dark Pulse) item ball disappeared": LocationData(200357, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0579, requires=""),
    "Route 16 - Rare Candy item ball disappeared": LocationData(200358, "Laverre Area", category=['FIELD ITEM'], flag_id=0x057A, requires=""),
    "Route 16 - Max Potion item ball disappeared": LocationData(200359, "Laverre Area", category=['FIELD ITEM'], flag_id=0x057B, requires=""),
    "Route 16 - Fist Plate item ball disappeared": LocationData(200360, "Laverre Area", category=['FIELD ITEM'], flag_id=0x057C, requires=""),
    ...
    "Lost Hotel - Twisted Spoon item ball disappeared": LocationData(200363, "Laverre Area", category=['FIELD ITEM'], flag_id=0x057F, requires=""),
    "Lost Hotel - TM95 (Snarl) item ball disappeared": LocationData(200364, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0580, requires=""),
    "Lost Hotel - Dread Plate item ball disappeared": LocationData(200365, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0581, requires=""),
    "Lost Hotel - Protector item ball disappeared": LocationData(200366, "Laverre Area", category=['FIELD ITEM'], flag_id=0x0582, requires=""),
    "Frost Cavern - Heart Scale item ball disappeared": LocationData(200367, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x0583, requires=""),
    "Frost Cavern - TM71 (Stone Edge) item ball disappeared": LocationData(200368, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x0584, requires=""),
    ...
    "Frost Cavern - Never-Melt Ice item ball disappeared": LocationData(200372, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x0588, requires=""),
    ...
    "Frost Cavern - Icy Rock item ball disappeared": LocationData(200376, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x058C, requires=""),
    "Route 18 - Icicle Plate item ball disappeared": LocationData(200377, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x058D, requires=""),
    "Route 18 - Calcium item ball disappeared": LocationData(200378, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x058E, requires=""),
    "Route 18 - Rare Candy item ball disappeared": LocationData(200379, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x058F, requires=""),
    "Route 19 - Hyper Potion item ball disappeared": LocationData(200380, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x0590, requires=""),
    "Route 19 - PP Up item ball disappeared": LocationData(200381, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x0591, requires=""),
    "Route 19 - X Defense item ball disappeared": LocationData(200382, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x0592, requires=""),
    "Route 19 - Max Ether item ball disappeared": LocationData(200383, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x0593, requires=""),
    "Terminus Cave - Star Piece item ball disappeared": LocationData(200384, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x0594, requires=""),
    "Terminus Cave - Heat Rock item ball disappeared": LocationData(200385, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x0595, requires=""),
    ...
    "Terminus Cave - Elixir item ball disappeared": LocationData(200390, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x059A, requires=""),
    ...
    "Terminus Cave - TM30 (Shadow Ball) item ball disappeared": LocationData(200393, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x059D, requires=""),
    ...
    "Terminus Cave - Dragon Scale item ball disappeared": LocationData(200395, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x059F, requires=""),
    ...
    "Route 20 - Max Revive item ball disappeared": LocationData(200397, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05A1, requires=""),
    "Route 20 - HP Up item ball disappeared": LocationData(200398, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05A2, requires=""),
    "Route 20 - Rare Bone item ball disappeared": LocationData(200399, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05A3, requires=""),
    "Route 20 - PP Up item ball disappeared": LocationData(200400, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05A4, requires=""),
    "Route 20 - Toxic Plate item ball disappeared": LocationData(200401, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05A5, requires=""),
    "Route 20 - TM36 (Sludge Bomb) item ball disappeared": LocationData(200402, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05A6, requires=""),
    "Route 21 - Paralyze Heal item ball disappeared": LocationData(200403, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05A7, requires=""),
    "Route 21 - Protein item ball disappeared": LocationData(200404, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05A8, requires=""),
    "Route 21 - Meadow Plate item ball disappeared": LocationData(200405, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05A9, requires=""),
    "Route 21 - X Accuracy item ball disappeared": LocationData(200406, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05AA, requires=""),
    "Route 21 - TM53 (Energy Ball) item ball disappeared": LocationData(200407, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05AB, requires=""),
    ...
    "Pokémon Village - Pixie Plate item ball disappeared": LocationData(200410, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05AE, requires=""),
    "Pokémon Village - TM29 (Psychic) item ball disappeared": LocationData(200411, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05AF, requires=""),
    "Route 21 - Insect Plate item ball disappeared": LocationData(200412, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05B0, requires=""),
    "Route 21 - Elixir item ball disappeared": LocationData(200413, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05B1, requires=""),
    "Route 21 - TM22 (Solar Beam) item ball disappeared": LocationData(200414, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05B2, requires=""),
    "Route 21 - Rare Candy item ball disappeared": LocationData(200415, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05B3, requires=""),
    "Route 21 - Repeat Ball item ball disappeared": LocationData(200416, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05B4, requires=""),
    ...
    "Victory Road - TM03 (Psyshock) item ball disappeared": LocationData(200418, "Victory Road", category=['FIELD ITEM'], flag_id=0x05B6, requires=""),
    "Victory Road - Rare Candy item ball disappeared": LocationData(200419, "Victory Road", category=['FIELD ITEM'], flag_id=0x05B7, requires=""),
    "Victory Road - Carbos item ball disappeared": LocationData(200420, "Victory Road", category=['FIELD ITEM'], flag_id=0x05B8, requires=""),
    "Victory Road - PP Up item ball disappeared": LocationData(200421, "Victory Road", category=['FIELD ITEM'], flag_id=0x05B9, requires=""),
    "Victory Road - Zinc item ball disappeared": LocationData(200422, "Victory Road", category=['FIELD ITEM'], flag_id=0x05BA, requires=""),
    ...
    "Victory Road - TM02 (Dragon Claw) item ball disappeared": LocationData(200426, "Victory Road", category=['FIELD ITEM'], flag_id=0x05BE, requires=""),
    ...
    "Couriway Town - TM80 (Rock Slide) item ball disappeared": LocationData(200438, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05CA, requires=""),
    ...
    "Chamber of Emptiness - Spooky Plate item ball disappeared": LocationData(200450, "Snowbelle Area", category=['FIELD ITEM'], flag_id=0x05D6, requires=""),
    ...
    "Route 22 - TM26 (Earthquake) item ball disappeared": LocationData(200459, "Victory Road", category=['FIELD ITEM'], flag_id=0x05DF, requires=""),
    ...
    "Azure Bay - Deep Sea Scale item ball disappeared": LocationData(200461, "Coumarine Area", category=['FIELD ITEM'], flag_id=0x05E1, requires=""),
    ...
    "Parfum Palace - HM01 (Cut) item ball disappeared": LocationData(200467, "Camphrier Area", category=['FIELD ITEM'], flag_id=0x05E7, requires="HM01 Cut"),
    ...
    "Coumarine City - Received Diploma for completing Central Kalos Pokédex (native) from Game Director": LocationData(200469, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x0A76, requires=""),
    "Coumarine City - Received Diploma for completing Coastal Kalos Pokédex (native) from Game Director": LocationData(200470, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x0A77, requires=""),
    "Coumarine City - Received Diploma for completing Mountain Kalos Pokédex (native) from Game Director": LocationData(200471, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x0A78, requires=""),
    "Coumarine City - Received Diploma for completing all Kalos Pokédexes (native) from Game Director": LocationData(200472, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x0A79, requires=""),
    "Coumarine City - Received Diploma for completing Central Kalos Pokédex from Game Director": LocationData(200473, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x0A7A, requires=""),
    "Coumarine City - Received Diploma for completing Coastal Kalos Pokédex from Game Director": LocationData(200474, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x0A7B, requires=""),
    "Coumarine City - Received Diploma for completing Mountain Kalos Pokédex from Game Director": LocationData(200475, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x0A7C, requires=""),
    "Coumarine City - Received Diploma for completing all Kalos Pokédexes from Game Director": LocationData(200476, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x0A7D, requires=""),
    "Coumarine City - Received Diploma for completing National Pokédex from Game Director": LocationData(200477, "Coumarine Area", category=['ITEM GIFT'], flag_id=0x0A7E, requires=""),
    ...
    "Azure Bay - Battled Fisherman Ewan": LocationData(201065, "Coumarine Area", category=["TRAINER"], flag_id=0x072E, requires=""),
    ...
    "Route 10 - Battled Team Flare Grunt": LocationData(201074, "Shalour Area", category=["TRAINER"], flag_id=0x073C, requires=""),
    ...
    "Route 10 - Battled Team Flare Grunt": LocationData(201087, "Shalour Area", category=["TRAINER"], flag_id=0x074D, requires=""),
    ...
    "Route 12 - Battled Swimmer ♂ Alessandro": LocationData(201100, "Coumarine Area", category=["TRAINER"], flag_id=0x0764, requires=""),
    ...
    "Power Plant - Team Flare Grunt M": LocationData(201116, "Lumiose Area", category=["TRAINER"], flag_id=0x077D, requires=""),
    "Power Plant - Team Flare Grunt M": LocationData(201117, "Lumiose Area", category=["TRAINER"], flag_id=0x077E, requires=""),
    "Power Plant - Team Flare Grunt F": LocationData(201118, "Lumiose Area", category=["TRAINER"], flag_id=0x077F, requires=""),
    "Power Plant - Team Flare Grunt F": LocationData(201119, "Lumiose Area", category=["TRAINER"], flag_id=0x0780, requires=""),
    "Power Plant - Team Flare Grunt F": LocationData(201120, "Lumiose Area", category=["TRAINER"], flag_id=0x0781, requires=""),
    "Power Plant - Team Flare Grunt F": LocationData(201121, "Lumiose Area", category=["TRAINER"], flag_id=0x0782, requires=""),
    ...
    "PokeBall Factory - Team Flare Grunt M": LocationData(201126, "Laverre Area", category=["TRAINER"], flag_id=0x07FD, requires=""),
    "PokeBall Factory - Team Flare Grunt M": LocationData(201127, "Laverre Area", category=["TRAINER"], flag_id=0x07FE, requires=""),
    "Lysandre Lab - Team Flare Grunt M": LocationData(201128, "Anistar Area", category=["TRAINER"], flag_id=0x0801, requires=""),
    "Lysandre Lab - Team Flare Grunt M": LocationData(201129, "Anistar Area", category=["TRAINER"], flag_id=0x0802, requires=""),
    "Lysandre Lab - Team Flare Grunt M": LocationData(201130, "Anistar Area", category=["TRAINER"], flag_id=0x0803, requires=""),
    "PokeBall Factory - Team Flare Grunt F": LocationData(201131, "Laverre Area", category=["TRAINER"], flag_id=0x0807, requires=""),
    "PokeBall Factory - Team Flare Grunt F": LocationData(201132, "Laverre Area", category=["TRAINER"], flag_id=0x0808, requires=""),
    "Lysandre Lab - Team Flare Grunt F": LocationData(201133, "Anistar Area", category=["TRAINER"], flag_id=0x080A, requires=""),
    "Lysandre Lab - Team Flare Grunt F": LocationData(201134, "Anistar Area", category=["TRAINER"], flag_id=0x080B, requires=""),
    "Lysandre Lab - Team Flare Grunt F": LocationData(201135, "Anistar Area", category=["TRAINER"], flag_id=0x080C, requires=""),
    ...
    "Azure Bay - Battled Sky Trainer Indra": LocationData(201159, "Coumarine Area", category=["TRAINER"], flag_id=0x084B, requires=""),
    ...
    "Azure Bay - Battled Swimmer ♂ Kieran": LocationData(201220, "Coumarine Area", category=["TRAINER"], flag_id=0x08AE, requires=""),
    "Azure Bay - Battled Swimmer ♀ Romy": LocationData(201221, "Coumarine Area", category=["TRAINER"], flag_id=0x08AF, requires=""),
    "Route 10 - Battled Psychic Robert": LocationData(201222, "Shalour Area", category=["TRAINER"], flag_id=0x08B0, requires=""),
    "Azure Bay - Battled Sky Trainer Elata": LocationData(201223, "Coumarine Area", category=["TRAINER"], flag_id=0x08D6, requires=""),
    "Azure Bay - Battled Swimmer ♀ Isla": LocationData(201224, "Coumarine Area", category=["TRAINER"], flag_id=0x08D8, requires=""),
    ...
    "Lysandre Lab - Team Flare Grunt F": LocationData(201248, "Anistar Area", category=["TRAINER"], flag_id=0x08F2, requires=""),
