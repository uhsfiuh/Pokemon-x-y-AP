...
location_table: Dict[str, LocationData] = {
    ...
    # Play-testing: Shalour gym is roller-skate gated, gating Tower of Mastery/main story progression
    "Shalour Area - Rumble Badge": LocationData(200003, "Shalour Area", category=["Badge"], flag_id=0x06E1, requires="Roller Skates"),
    "Coumarine Area - Plant Badge": LocationData(200004, "Coumarine Area", category=["Badge"], flag_id=0x06E2),
    # Voltage Badge is behind the Lumiose Gym, which sits in central Lumiose behind the Power Plant Pass.
    "Lumiose Area - Voltage Badge": LocationData(200005, "Lumiose Area", category=["Badge"], flag_id=0x06E3, requires="Power Plant Pass"),
    ...
    # Play-testing: Shalour gym is roller-skate gated, gating Tower of Mastery/main story progression
    "Shalour City - Received HM03 (Surf) from Calem/Serena": LocationData(200493, "Shalour Area", category=['ITEM GIFT'], flag_id=0x0A51, requires="Roller Skates"),
    ...
    # Play-testing: sits on a grind rail, requires Roller Skates (Bulbapedia doesn't note this)
    "Route 5 - Super Potion item ball disappeared": LocationData(200277, "Camphrier Area", category=['FIELD ITEM'], flag_id=0x0529, requires="Roller Skates"),
    # Play-testing: sits on a grind rail, requires Roller Skates (Bulbapedia doesn't note this)
    "Route 5 - Super Potion item ball disappeared (2)": LocationData(200278, "Camphrier Area", category=['FIELD ITEM'], flag_id=0x052A, requires="Roller Skates"),
    "Route 5 - Great Ball item ball disappeared": LocationData(200279, "Camphrier Area", category=['FIELD ITEM'], flag_id=0x052B, requires=""),
    # Play-testing: sits on a grind rail, requires Roller Skates (Bulbapedia doesn't note this)
    "Route 5 - TM01 (Hone Claws) item ball disappeared": LocationData(200280, "Camphrier Area", category=['FIELD ITEM'], flag_id=0x052C, requires="Roller Skates"),
    ...
    # Play-testing: Power Plant Pass gates the Power Plant interior, not the region entrance
    "Kalos Power Plant - Zap Plate item ball disappeared": LocationData(200445, "Lumiose Area", category=['FIELD ITEM'], flag_id=0x05D1, requires="Power Plant Pass"),
    ...
    # Lumiose Gym is in central Lumiose, gated behind the Power Plant Pass.
    "Lumiose City (Gym 4F) - Ace Trainer Mathis": LocationData(201008, "Lumiose Area", category=["TRAINER"], flag_id=0x06E8, requires="Power Plant Pass"),
    "Lumiose City (Gym 4F) - Ace Trainer Maxim": LocationData(201009, "Lumiose Area", category=["TRAINER"], flag_id=0x06E9, requires="Power Plant Pass"),
    "Lumiose City (Gym 4F) - Ace Trainer Rico": LocationData(201010, "Lumiose Area", category=["TRAINER"], flag_id=0x06EA, requires="Power Plant Pass"),
    ...
    # Play-testing: reported unreachable without HM01 Cut
    "Route 5 - Battled Youngster Anthony": LocationData(201018, "Camphrier Area", category=["TRAINER"], flag_id=0x06F6, requires="HM01 Cut"),
    ...
    # Play-testing: reported unreachable without HM03 Surf and HM05 Waterfall
    "Route 22 - Battled Ace Trainer Adelbert": LocationData(201038, "Victory Road", category=["TRAINER"], flag_id=0x070D, requires="HM03 Surf AND HM05 Waterfall"),
    # Play-testing: reported unreachable without HM03 Surf and HM05 Waterfall
    "Route 22 - Battled Ace Trainer Hilde": LocationData(201039, "Victory Road", category=["TRAINER"], flag_id=0x070E, requires="HM03 Surf AND HM05 Waterfall"),
    ...
    # Play-testing: reported unreachable without Roller Skates
    "Shalour City (Gym) - Battled Roller Skater Shun": LocationData(201052, "Shalour Area", category=["TRAINER"], flag_id=0x071F, requires="Roller Skates"),
    # Play-testing: reported unreachable without Roller Skates
    "Shalour City (Gym) - Battled Roller Skater Rolanda": LocationData(201053, "Shalour Area", category=["TRAINER"], flag_id=0x0720, requires="Roller Skates"),
    ...
    # Play-testing: reported unreachable without HM03 Surf
    "Route 8 (Coast) - Battled Swimmer ♂ Ramses": LocationData(201068, "Cyllage Area", category=["TRAINER"], flag_id=0x0731, requires="HM03 Surf"),
    # Play-testing: reported unreachable without HM03 Surf
    "Route 8 (Coast) - Battled Swimmer ♂ Estaban": LocationData(201069, "Cyllage Area", category=["TRAINER"], flag_id=0x0732, requires="HM03 Surf"),
    ...
    # Play-testing: reported unreachable without Roller Skates
    "Shalour City (Gym) - Battled Roller Skater Kate": LocationData(201094, "Shalour Area", category=["TRAINER"], flag_id=0x075E, requires="Roller Skates"),
    # Play-testing: reported unreachable without Roller Skates
    "Shalour City (Gym) - Battled Roller Skater Dash": LocationData(201095, "Shalour Area", category=["TRAINER"], flag_id=0x075F, requires="Roller Skates"),
    ...
    # Inside the Kalos Power Plant, so all six sit behind the Power Plant Pass --
    # same as the Zap Plate. These were ungated because only the item location had
    # the requirement applied.
    "Power Plant - Team Flare Grunt M (1)": LocationData(201116, "Lumiose Area", category=["TRAINER"], flag_id=0x077D, requires="Power Plant Pass"),
    "Power Plant - Team Flare Grunt M (2)": LocationData(201117, "Lumiose Area", category=["TRAINER"], flag_id=0x077E, requires="Power Plant Pass"),
    "Power Plant - Team Flare Grunt F (1)": LocationData(201118, "Lumiose Area", category=["TRAINER"], flag_id=0x077F, requires="Power Plant Pass"),
    "Power Plant - Team Flare Grunt F (2)": LocationData(201119, "Lumiose Area", category=["TRAINER"], flag_id=0x0780, requires="Power Plant Pass"),
    "Power Plant - Team Flare Grunt F (3)": LocationData(201120, "Lumiose Area", category=["TRAINER"], flag_id=0x0781, requires="Power Plant Pass"),
    "Power Plant - Team Flare Grunt F (4)": LocationData(201121, "Lumiose Area", category=["TRAINER"], flag_id=0x0782, requires="Power Plant Pass"),
    ...
    # Lumiose Gym is in central Lumiose, gated behind the Power Plant Pass.
    "Lumiose City (Gym 2F) - Schoolboy Arno": LocationData(201209, "Lumiose Area", category=["TRAINER"], flag_id=0x0899, requires="Power Plant Pass"),
    "Lumiose City (Gym 2F) - Schoolboy Sherlock": LocationData(201210, "Lumiose Area", category=["TRAINER"], flag_id=0x089A, requires="Power Plant Pass"),
    "Lumiose City (Gym 2F) - Schoolboy Finnian": LocationData(201211, "Lumiose Area", category=["TRAINER"], flag_id=0x089B, requires="Power Plant Pass"),
    "Lumiose City (Gym 3F) - Rising Star Estel": LocationData(201212, "Lumiose Area", category=["TRAINER"], flag_id=0x089C, requires="Power Plant Pass"),
    "Lumiose City (Gym 3F) - Rising Star Nelly": LocationData(201213, "Lumiose Area", category=["TRAINER"], flag_id=0x089D, requires="Power Plant Pass"),
    "Lumiose City (Gym 3F) - Rising Star Helene": LocationData(201214, "Lumiose Area", category=["TRAINER"], flag_id=0x089E, requires="Power Plant Pass"),
    "Lumiose City (Gym 5F) - Poké Fan Abigail": LocationData(201215, "Lumiose Area", category=["TRAINER"], flag_id=0x089F, requires="Power Plant Pass"),
    "Lumiose City (Gym 5F) - Poké Fan Lydie": LocationData(201216, "Lumiose Area", category=["TRAINER"], flag_id=0x08A0, requires="Power Plant Pass"),
    "Lumiose City (Gym 5F) - Poké Fan Tara": LocationData(201217, "Lumiose Area", category=["TRAINER"], flag_id=0x08A1, requires="Power Plant Pass"),
